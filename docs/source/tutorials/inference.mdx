...
## With IntelGaudiAcceleratorTrainer

You can find below a template to perform inference with a `IntelGaudiAcceleratorTrainer` instance where we want to compute the accuracy over the given dataset:
