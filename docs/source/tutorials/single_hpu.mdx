...
- You need to replace the Transformers' [`Trainer`](https://huggingface.co/docs/transformers/main_classes/trainer) class with the [`IntelGaudiAcceleratorTrainer`](https://huggingface.co/docs/optimum/habana/package_reference/trainer) class,
