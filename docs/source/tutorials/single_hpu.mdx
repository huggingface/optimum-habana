...
To go further, we invite you to read our guides about [accelerating training](https://huggingface.co/docs/optimum/habana/usage_guides/accelerate_training) and [pretraining](https://huggingface.co/docs/optimum/habana/usage_guides/pretraining).
