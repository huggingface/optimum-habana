...
# What are Intel:registered: Gaudi:registered: accelerator first-generation Gaudi, Gaudi2 and HPUs?
...
See [here](../usage_guides/accelerate_training#lazy-mode) how to use these execution modes in 🤗 Optimum for Intel:registered: Gaudi:registered: accelerator.
