...
See [here](https://huggingface.co/docs/optimum/habana/tutorials/accelerate_training#lazy-mode) how to use these execution modes in 🤗 Optimum Habana.
...
- *Scale-up* to 8 devices on one server. See [here](../usage_guides/distributed) how to perform distributed training on a single node.
- *Scale-out* to 1000s of devices on several servers. See [here](https://huggingface.co/docs/optimum/habana/usage_guides/multi_node_training) how to do multi-node training.
