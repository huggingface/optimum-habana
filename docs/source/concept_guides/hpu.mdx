...
# What are Intel(R) Gaudi(R) accelerator's first-generation Gaudi, Gaudi2 and HPUs?
...
See [here](../usage_guides/accelerate_training#lazy-mode) how to use these execution modes in 🤗 Optimum Intel(R) Gaudi(R) accelerator.
