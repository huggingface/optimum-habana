...
At the time of writing this guide, latest Optimum for Intel Gaudi release version was v1.21.1, which is paired with Intel Gaudi Software release
version 1.24.0.  Install Optimum for Intel Gaudi as follows:

```bash
git clone -b v1.21.1 https://github.com/huggingface/optimum-habana
