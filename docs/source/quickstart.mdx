...
automatically download and run the docker. At the time of writing this guide, latest Gaudi docker version was 1.23.0:
...
At the time of writing this guide, latest Optimum for Intel Gaudi release version was v1.20.0, which is paired with Intel Gaudi Software release
version 1.23.0.  Install Optimum for Intel Gaudi as follows:

```bash
git clone -b v1.20.0 https://github.com/huggingface/optimum-habana
