...
| Gemma3       |           | ✅        | <li>[text generation](https://github.com/huggingface/optimum-habana/tree/v1.20-release/examples/text-generation)</li> |
...
| Qwen2.5-VL |        |  <div style="text-align:left"><li>Single card</li></div> | <li>[image to text](https://github.com/huggingface/optimum-habana/tree/v11.20-release/examples/image-to-text)</li> |
