...
🤗 Optimum for Intel:registered: Gaudi:registered: accelerator is the interface between the 🤗 Transformers and 🤗 Diffusers libraries and [Intel:registered: Gaudi:registered: accelerator Gaudi processor (HPU)](https://docs.habana.ai/en/latest/index.html).
