...
🤗 Optimum for Intel® Gaudi® accelerator is the interface between the 🤗 Transformers and 🤗 Diffusers libraries and [Intel® Gaudi® accelerator Gaudi processor (HPU)](https://docs.habana.ai/en/latest/index.html).
