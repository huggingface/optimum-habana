...
The following model architectures, tasks and device distributions are supported for 🤗 Optimum Habana:
...
<div class="mt-10">
  <div class="w-full flex flex-col space-y-4 md:space-y-0 md:grid md:grid-cols-2 md:gap-y-4 md:gap-x-5">
    <a class="!no-underline border dark:border-gray-700 p-5 rounded-lg shadow hover:shadow-lg" href="./tutorials/overview"
      ...
      <p class="text-gray-700">Learn the basics and become familiar with training transformers on HPUs with 🤗 Optimum. Start here if you are using 🤗 Optimum for the first time!</p>
    </a>
    ...
    <a class="!no-underline border dark:border-gray-700 p-5 rounded-lg shadow hover:shadow-lg" href="./package_reference/trainer"
      ...
      <p class="text-gray-700">Technical descriptions of how the Habana classes and methods of 🤗 Optimum work.</p>
    </a>
  </div>
</div>
