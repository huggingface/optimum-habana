...
Other examples of configurations for HPUs are proposed [here](https://github.com/HabanaAI/Model-References/tree/1.9.0/PyTorch/nlp/pretraining/deepspeed-bert/scripts) by Habana.
