...
- You need to replace the Transformers' [`Trainer`](https://huggingface.co/docs/transformers/main_classes/trainer) class by the [`GaudiTrainer`](https://huggingface.co/docs/optimum/habana/package_reference/trainer) class,
