...
- You need to replace the [Transformers' `Trainer` class](https://huggingface.co/docs/transformers/main_classes/trainer) by the `GaudiTrainer` class,
- You need to replace the [Transformers' `TrainingArguments` class](https://huggingface.co/docs/transformers/main_classes/trainer#transformers.TrainingArguments) by the `GaudiTrainingArguments` class and add the following arguments:
