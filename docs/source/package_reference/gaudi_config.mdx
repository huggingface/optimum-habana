...
- `autocast_bf16ops` list of operations that should be run with bf16 precision under autocast context
- `autocast_fp32_ops` list of operations that should be run with fp32 precision under autocast context
