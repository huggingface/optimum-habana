...
[[autodoc]] habana.transformers.trainer.GaudiTrainer
    - all

## GaudiSeq2SeqTrainer

[[autodoc]] habana.transformers.trainer_seq2seq.GaudiSeq2SeqTrainer
    - evaluate
    - predict

## GaudiTrainingArguments

[[autodoc]] habana.transformers.training_args.GaudiTrainingArguments
    - all

## GaudiSeq2SeqTrainingArguments

[[autodoc]] habana.transformers.training_args_seq2seq.GaudiSeq2SeqTrainingArguments
    - all
