...
Pretraining models from Transformers, like BERT, is as easy as fine-tuning it.
...
Here is a working example where BERT is pretrained for masked language modeling:
```python
