...
The [`GaudiTrainer`](https://huggingface.co/docs/optimum/main/en/habana_trainer#optimum.habana.GaudiTrainer) allows to use DeepSpeed as easily as the [Transformers Trainer](https://huggingface.co/docs/transformers/main_classes/trainer).
