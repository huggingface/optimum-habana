#!/usr/bin/env python3
# PyTorch Training Script for TIMM models with Gaudi2 Lazy Mode
# Copy from https://github.com/huggingface/pytorch-image-models/blob/main/train.py, enable it with gaudi2 lazy mode
