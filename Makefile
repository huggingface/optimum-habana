...
fast_tests:
	...
	python -m pytest -v -s tests/test_gaudi_configuration.py tests/test_trainer.py tests/test_trainer_seq2seq.py tests/test_habana_profiler_unit.py
...
slow_tests_1x: test_installs
	...
	python -m pytest tests/test_lora_vlm.py -v -s -k test_llava_lora_vlm || status5=$$?; \
