...
doc: build_doc_docker_image
	...
	docker run -v $(CURRENT_DIR):/doc_folder --workdir=/doc_folder doc_maker doc-builder build optimum.habana /optimum-habana/docs/source/ --build_dir $(BUILD_DIR) --html --clean
