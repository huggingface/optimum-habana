...
class GaudiStableDiffusionXLPipeline(
    GaudiDiffusionPipeline, FromSingleFileMixin, StableDiffusionXLLoraLoaderMixin, TextualInversionLoaderMixin
):
    r"""
    Pipeline for text-to-image generation using Stable Diffusion XL.

    This model inherits from [`GaudiDiffusionPipeline`]. Check the superclass documentation for the generic methods the
        ...
        **kwargs,
        ...
        Args:
            ...
            callback_on_step_end (`Callable`, *optional*):
                ...
                with the following arguments: `callback_on_step_end(self: GaudiDiffusionPipeline, step: int, timestep: int,
