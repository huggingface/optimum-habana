...
from diffusers.pipelines.flux.pipeline_flux_kontext import FluxKontextPipeline, calculate_shift, retrieve_timesteps
...
EXAMPLE_DOC_STRING = """
    Examples:
        ...
        >>> from optimum.habana.diffusers import GaudiFluxKontextPipeline

        >>> pipe = GaudiFluxKontextPipeline.from_pretrained(
...
class GaudiFluxKontextPipeline(GaudiDiffusionPipeline, FluxKontextPipeline):
    r"""
    Adapted from https://github.com/huggingface/diffusers/blob/v0.35.2/src/diffusers/pipelines/flux/pipeline_flux_kontext.py#L190
    ...
    def __call__(
        ...
        **kwargs,
        ...
        r"""
        Adapted from https://github.com/huggingface/diffusers/blob/v0.35.2/src/diffusers/pipelines/flux/pipeline_flux_kontext.py#L728
