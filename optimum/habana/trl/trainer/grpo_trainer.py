...
from optimum.habana.transformers.generation.configuration_utils import GaudiGenerationConfig
...
class GaudiGRPOTrainer(GRPOTrainer, GaudiTrainer):
    def __init__(
        ...
        if self.use_vllm:
            ...
            self.generation_config = GaudiGenerationConfig( ###use GaudiGenConfig instead of GenConfig
