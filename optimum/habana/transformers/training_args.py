...
from ..utils.features import IsFusedSDPAAvailable, Not
...
class GaudiTrainingArguments(TrainingArguments):
    ...
    def __post_init__(self):
        ...
        if self.attn_implementation == "gaudi_fused_sdpa" and Not(IsFusedSDPAAvailable()):
            raise ValueError("Cannot use gaudi_fused_sdpa, FusedSDPA kernel is not available")
