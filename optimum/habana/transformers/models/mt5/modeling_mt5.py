...
def gaudi_MT5LayerSelfAttention_forward(
    self,
    hidden_states,
    attention_mask=None,
    position_bias=None,
...
def gaudi_MT5ForConditionalGeneration_forward(
        self,
...
def gaudi_MT5ForConditionalGeneration_prepare_inputs_for_generation(
    self,
    input_ids,
    past_key_values=None,
    attention_mask=None,
