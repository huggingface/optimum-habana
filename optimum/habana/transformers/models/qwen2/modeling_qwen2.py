...
def gaudi_qwen2_attention_forward(
    ...
    **kwargs,
    ...
    """
    Copied from Qwen2Attention.forward: https://github.com/huggingface/transformers/blob/v4.38.2/src/transformers/models/qwen2/modeling_qwen2.py
...
def gaudi_qwen2_model_forward(
    ...
    """
    Copied from Qwen2Model.forward: https://github.com/huggingface/transformers/blob/v4.38.2/src/transformers/models/qwen2/modeling_qwen2.py
    The only differences are:
    - add new args token_idx
...
class GaudiQwen2ForCausalLM(Qwen2ForCausalLM):
    def forward(
        ...
        """
        Inherits from Qwen2ForCausalLM: https://github.com/huggingface/transformers/blob/v4.38.2/src/transformers/models/qwen2/modeling_qwen2.py
        The only differences are:
        - add new args token_idx
        """
