...
class ExaoneModel(ExaonePreTrainedModel):
    ...
    def forward(
        ...
        attn_softmax_bf16: Optional[bool] = None,
        use_flash_attention: Optional[bool] = None,
        reuse_cache: Optional[bool] = None,
        flash_attention_recompute: Optional[bool] = None,
        flash_attention_causal_mask: Optional[bool] = None,
        flash_attention_fast_softmax: Optional[bool] = None,
        **kwargs,
