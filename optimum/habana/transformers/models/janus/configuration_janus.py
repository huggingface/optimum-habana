...
class VisionConfig(PretrainedConfig):
    ...
    def __init__(self, **kwargs):
        ...
        self.image_size = params.get("image_size", 384)
...
class GenVisionConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        params: dict = kwargs.get("params", {})
        self.encoder_ch_mult = encoder_ch_mult or params.get(
            "encoder_ch_mult", [1, 1, 2, 2, 4]
        )
        self.decoder_ch_mult = decoder_ch_mult or params.get(
...
class GenAlignerConfig(MlpProjectorConfig):
    ...
    def __init__(self, **kwargs):
        ...
        self.input_dim = params.get("input_dim", 8)
        self.n_embed = params.get("n_embed", 4096)
        self.projector_type = params.get("projector_type", "mlp_gelu")
