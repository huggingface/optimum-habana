#                🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨
#           This file was automatically generated from /root/workspace/optimum-habana/optimum/habana/transformers/models/llama/modular_llama.py.
#               Do NOT edit this file manually as any edits will be overwritten by the generation of
#             the file from the modular. If any change should be done, please apply the change to the
#                          modular_llama.py file directly. One of our CI enforces this.
#                🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨
...
@no_op_decorator
class GaudiLlamaRMSNorm(nn.Module):
    def __init__(self, hidden_size, eps=1e-6, use_fused_rms_norm=True):
        """
        GaudiLlamaRMSNorm is equivalent to T5LayerNorm
        """
        super().__init__()
...
@auto_docstring
class GaudiLlamaPreTrainedModel(PreTrainedModel):
    config: GaudiLlamaConfig
