...
def gaudi_mpt_attention_forward(
    ...
    kv_cache_len: Optional[torch.Tensor] = None,
):
    """
    ...
    if past_key_value is not None:
        ...
        if cache_idx is not None:
            cache_shape = (batch_size, self.n_heads, kv_cache_len, self.head_dim)
            past_key_value = [
        ...
        model_inputs.update(
            {
                ...
                "token_idx": token_idx,
                "cache_idx": cache_idx,
                "kv_cache_len": kwargs["kv_cache_len"],
            }
        )
        return model_inputs
