...
from transformers import DebertaV2ForQuestionAnswering, DebertaV2ForSequenceClassification
...
@register(DebertaV2ForSequenceClassification)
# Copied from transformers.models.deberta.modeling_deberta.DebertaForSequenceClassification with Deberta->DebertaV2
class GaudiDebertaV2ForSequenceClassification(DebertaV2PreTrainedModel, GaudiMixin):
    def __init__(self, config):
        super().__init__(config)
...
@register(DebertaV2ForQuestionAnswering)
# Copied from transformers.models.deberta.modeling_deberta.DebertaForQuestionAnswering with Deberta->DebertaV2
class GaudiDebertaV2ForQuestionAnswering(DebertaV2PreTrainedModel, GaudiMixin):
    _keys_to_ignore_on_load_unexpected = [r"pooler"]
