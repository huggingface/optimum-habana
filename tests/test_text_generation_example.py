...
if os.environ.get("GAUDI2_CI", "0") == "1":
    ...
    MODEL_OUTPUTS = {
        ...
        "Qwen/Qwen2-7B": "DeepSpeed is a machine learning framework that provides a suite of tools for training large-scale models. It is designed to be highly scalable and efficient, making it ideal for training models on large datasets. DeepSpeed is built on top of PyTorch and supports a wide range of models, including transformer-based models like BERT and GPT-2. It also provides support for distributed training, allowing models to be trained on multiple GPUs or even multiple machines. DeepSpeed is open source and can be used for both research and production applications.",
    }
else:
    # Gaudi1 CI baselines
    MODELS_TO_TEST = {
