...
if OH_DEVICE_CONTEXT not in ["gaudi1"]:
    ...
    MODELS_TO_TEST = {
        "bf16_1x": [
            ...
            pytest.param("state-spaces/mamba-130m-hf", 1536, False, False, False, marks=pytest.mark.skip("Deprecated")),
...
@pytest.mark.parametrize("model_name, batch_size, reuse_cache, check_output, use_flex_attention", MODELS_TO_TEST["bf16_1x"])
