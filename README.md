...
| Wan         |               | <li>Single card</li> |  <li>[text-to-image generation](/examples/stable-diffusion#text-to-video-with-wan-22)</li><li>[image-to-image generation](/examples/stable-diffusion#image-to-video-with-wan-22)</li> |
