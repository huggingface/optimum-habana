...
- [GaudiTrainer](https://huggingface.co/docs/optimum/habana/package_reference/trainer): the trainer class that takes care of compiling lazy mode and distributing the model to run on HPUs, and performing training and evaluation.
