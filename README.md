...
| RoBERTa | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | <div style="text-align:left;margin:0;"><ul style="margin-bottom:0;"><li>[question answering](https://github.com/huggingface/optimum-habana/tree/main/examples/question-answering)</li><li>[language modeling](https://github.com/huggingface/optimum-habana/tree/main/examples/language-modeling)</li></ul></div> |
