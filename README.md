...
> The current Optimum for Intel Gaudi has been validated with Intel Gaudi v1.23 stack.
...
```
with `v1.20.0` being the latest Optimum for Intel Gaudi release version.
