...
| Phi | <div style="text-align:left"><li>DeepSpeed</li><li>LoRA</li></div>  | <div style="text-align:left"><li>Single card</li></div> | <li>[text generation](https://github.com/huggingface/optimum-habana/tree/main/examples/text-generation)</li> |
